...
int main(void)
{
    ...
    if (option == 'A') {
        cout << today.get_temp_kelvin() << " degrees Kelvin is "
        << today.get_temp_celsius() << " degrees Celsius and "
        << today.get_temp_fahrenheit() << " degrees Fahrenheit.\n";
    }
    else if (option == 'B') {
        cout << today.get_temp_celsius() << " degrees Celsius is "
        << today.get_temp_kelvin() << " degrees Kelvin and "
        << today.get_temp_fahrenheit() << " degrees Fahrenheit.\n";
    }
    else {
        cout << today.get_temp_fahrenheit() << " degrees Fahrenheit is "
        << today.get_temp_kelvin() << " degrees Kelvin and "
        << today.get_temp_celsius() << " degrees Celsius.\n";
    }
